	...
	<body>
		...
		<form:form method="POST" action="/springhibernatemvc/save.html">
	   		<table>
			    ...
			    <tr>
			        <td><form:label path="type">Property Type:</form:label></td>
			        <td><form:input path="type" value="${property.type}"/></td>
			    </tr>
			    <tr>
	...
	<table align="left" border="1">
		...
		<c:forEach items="${properties}" var="property">
			<tr>
				...
				<td align="center"><a href="edit.html?id=${property.id}">Edit</a> | <a href="delete.html?id=${property.id}">Delete</a></td>
			</tr>
		</c:forEach>
	</table>
</c:if>
