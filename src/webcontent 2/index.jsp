	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="sellindex.jsp" class="nav-link">Sell</a></li>
			<div class="dropdown">
        ...
        <div class="row d-flex">
          ...
          <div class="col-md-3 d-flex ftco-animate">
              ...
              <div class="text">
                ...
                <a href="blog-single.jsp" class="block-20 img" style="background-image: url('images/image_2.jpg');">
	              </a>
                <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
              </div>
            </div>
          ...
          <div class="col-md-3 d-flex ftco-animate">
              ...
              <div class="text">
                ...
                <a href="blog-single.jsp" class="block-20 img" style="background-image: url('images/image_3.jpg');">
	              </a>
                <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
              </div>
            </div>
          ...
          <div class="col-md-3 d-flex ftco-animate">
              ...
              <div class="text">
                ...
                <a href="blog-single.jsp" class="block-20 img" style="background-image: url('images/image_4.jpg');">
	              </a>
                <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
              </div>
            </div>
